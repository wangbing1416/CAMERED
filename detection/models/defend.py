...
class dEFENDBERTModel(torch.nn.Module):
    def __init__(self, pretrain_name, emb_dim, mlp_dims, dropout, category):
        super(dEFENDBERTModel, self).__init__()
        ...
        self.mlp = MLP(emb_dim * 4, [mlp_dims], output_dim=category, dropout=dropout)
    ...
    def forward(self, **kwargs):
        ...
        output = self.mlp(torch.cat([feature, co_feature_A, co_feature_B], dim=1))
